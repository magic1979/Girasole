var app = {
    ...
    receivedEvent: function(id) {
		...
		if(PushbotsPlugin.isiOS()){
			PushbotsPlugin.initializeiOS("56265fd8177959ba058b4567");
		}
		if(PushbotsPlugin.isAndroid()){
			PushbotsPlugin.initializeAndroid("56265fd8177959ba058b4567", "163804659077");
		}
...
function CambiaLingua(){
		...
		if(localStorage.getItem("Lingua")==2){
			...
			$("#img2").html("");
			$("#img3").html("");
			$("#img4").html("Spaghetti alla Norma");
			$("#img5").html("Rigatoni alla Carbonara");
			$("#img6").html("Tonnarelli, Gamberi e Zucchine");
			$("#img7").html("Bucatini all'Amatriciana");
			$("#img8").html("Orecchiette Spek e Zafferano");
		}
}
...
function regToken() {
	...
	if (localStorage.getItem("Token") === null || typeof (localStorage.getItem("Token")) == 'undefined' || localStorage.getItem("Token") == "null") {
	    ...
	    $.ajax({
	        type: "GET",
	        url: "http://interactivebusinessapp.it/device/set_token/PxgLiaL7dBgTYUzUyHZRNGIUlT5NIabyHrkZC57PHoJGiiAQZA/3hio0FyItm1PFhkYsf8azFxxfdNSmFQpX8NYNlHhII6oZqmsGv/" + localStorage.getItem("Token") + "",
	        ...
	        //data: {token:localStorage.getItem("Token")}, 3hio0FyItm1PFhkYsf8azFxxfdNSmFQpX8NYNlHhII6oZqmsGv
	        contentType: "application/json; charset=utf-8",
	        json: 'callback',
	        timeout: 7000,
	        crossDomain: true,
...
function aprifb () {
	var ref = window.open('https://m.facebook.com/trattoriamontiilgirasole?fref=ts', '_system', 'location=no');
}
...
function apritrip () {
	var ref = window.open('http://www.tripadvisor.it/Restaurant_Review-g187791-d5452777-Reviews-Il_Girasole-Rome_Lazio.html', '_system', 'location=no');
}
...
if(localStorage.getItem("Lingua")==2){
		window.plugin.email.open({
								 to:      "",
								 subject: "",
								 body:    "The Digital Business Card IBA 'Il Girasole' is available at the link http://www.interactivebusinessapp.it/download/il_girasole",
								 isHtml:  true
								 });
	}
	else{
		window.plugin.email.open({
								 to:      "",
								 subject: "",
								 body:    "La Digital Business Card IBA di 'Il Girasole' e' disponibile al link http://www.interactivebusinessapp.it/download/il_girasole",
								 isHtml:  true
								 });
...
if(localStorage.getItem("Lingua")==2){
			window.plugins.socialsharing.shareViaSMS("The Digital Business Card IBA 'Il Girasole' is available at the link http://www.interactivebusinessapp.it/download/il_girasole", "", function(msg) {console.log('ok: ' + msg)}, function(msg) {alert('error: ' + msg)})
	}
	else
	{
			window.plugins.socialsharing.shareViaSMS("La Digital Business Card IBA di 'Il Girasole' e' disponibile al link http://www.interactivebusinessapp.it/download/il_girasole", "", function(msg) {console.log('ok: ' + msg)}, function(msg) {alert('error: ' + msg)})
...
function aprimappa () {
	...
	window.open("google.navigation:q=41.897711,12.490243&mode=d" , '_system');
